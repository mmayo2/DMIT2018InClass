       ...
       <div class="pull-right col-md-5">
        ...
        <div class="col-md-7">
            <details open>
                ...
                <asp:GridView ID="SeatingGridView" runat="server" CssClass="table table-hover table-striped table-condensed" OnSelectedIndexChanging="SeatingGridView_SelectedIndexChanging" ItemType="eRestaurant.Entities.DTOs.SeatingSummary" AutoGenerateColumns="False" DataSourceID="SeatingDataSource">
                    <Columns>
                        ...
                        <asp:TemplateField>
                            <ItemTemplate>
                                ...
                                <asp:Panel ID="WalkInSeatingPanel" runat="server" CssClass="input-group input-group-sm" Visible="<%# ! Item.Taken%>">
                                    ...
                                    <span class="input-group-addon" style="width:5px; padding:0; border:0; background-color:white;">
                                    </span>
                                    <asp:LinkButton ID="LinkButton1" runat="server" Text="Seat Customers" CssClass="input-group-btn" CommandName="Select" CausesValidation="false"></asp:LinkButton>
                                </asp:Panel>
                                <asp:Panel ID="OccupiedSeatingPanel" runat="server" Visible="<%# Item.Taken%>">
                                    <%--Waiter - Reservation Name - $$--%>
                                    <%# Item.Waiter %>
                                    <asp:Label ID="ReservationName" runat="server" Text='<%# "&mdash; " + Item.ReservationName %>' Visible='<%# !string.IsNullOrEmpty(Item.ReservationName)%>' />
